...
def retry(k,session,cont):
    try:
        ...
        session.post(url=class2, headers=headers,proxies=proxies,timeout=5)
        ...
        for i in iden:
            ...
            e = session.post(url='https://salad.academy/api/notifications', headers=headers,proxies=proxies,timeout=5, json=data)
...
for cnt in range(int(start),int(end)):
    while 1:
        try:
            ...
            headers = {
                ...
                'User-Agent': "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Win64; x64; Trident/6.0)",
                'anonymous - token': '62588c11be7a028f34f6anon'
            }
            ipli = ['us', '', 'kr', 'jp', 'hk', 'tw', 'fr', 'gb', 'de', 'lu', 'ca', 'mx', 'br', 'nz', 'au']
            rrr = random.randint(0, len(ipli) - 1)
            mid = ipli[rrr]
    ...
    while 1:
        try:
            ...
            data = {
                "email": mail, "password": "cumark", "recaptchaToken": recaptchaToken
            }

            session = requests.Session()
            ur = 'https://salad.academy/api/signin'
            con = session.post(url=ur, headers=headers,proxies=proxies, timeout=5, json=data)
    ...
    try:
        ...
        class2='https://salad.academy/api/user/register/6204be454d1e14096f23305a'
        pag='https://salad.academy/course/axie-arena-mastery'
        con=session.get(url=pag,headers=headers,proxies=proxies,timeout=5)
        data1={
            "token":cont,
        }
        #print(con.text)
        ...
        "token":cont,
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.75 Safari/537.36'}
        e=session.post(url=class2,headers=headers,proxies=proxies,timeout=5)
        print(e)
        class2='https://salad.academy/api/user/register/6204be8c0ed4966476289783'
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/620b165f657c7401c74fe1f8',json=data,headers=headers,proxies=proxies,timeout=5)
        ...
        e=session.patch(url='https://salad.academy/api/assessment/submission/62509fa4054fa90202635494',json=data,headers=headers,proxies=proxies,timeout=5)
        ...
        #data={"maxscore":35,"answers":[{"qId":"new1644938251345_0_7505278","qIndex":0,"optionid":"new1644938251345_0_7505278opt_1"},{"qId":"new1644938251345_0_5419541","qIndex":"1","optionid":"new1644938251345_0_5419541opt_1"},{"qId":"new1644938251345_0_5146844","qIndex":"3","optionid":"new1644938251345_0_5146844opt_2"},{"qId":"new1644938251345_0_5112539","qIndex":"4","optionid":"new1644938251345_0_5112539opt_2"},{"qId":"new1644938251345_0_5116870","qIndex":"5","optionid":"new1644938251345_0_5116870opt_2"},{"qId":"new1644938251345_0_3504548","qIndex":"8","optionid":"new1644938251345_0_3504548opt_2"},{"qId":"new1644938251345_0_5525304","qIndex":"13","optionid":"new1644938251345_0_5525304opt_2"},{"qId":"new1644938251345_0_7951755","qIndex":"14","optionid":"new1644938251345_0_7951755opt_2"},{"qId":"new1644938251345_0_6919476","qIndex":"15","optionid":"new1644938251345_0_6919476opt_3"},{"qId":"new1644938251345_0_7639759","qIndex":"16","optionid":"new1644938251345_0_7639759opt_1"}]}
        e=session.post(url='https://salad.academy/api//score/certificate/620a18fa5ba7ad2f5d595e29',json=data,headers=headers,proxies=proxies,timeout=5)
        ...
        #data={"maxscore":35,"answers":[{"qId":"new1644938251345_0_7505278","qIndex":0,"optionid":"new1644938251345_0_7505278opt_1"},{"qId":"new1644938251345_0_5419541","qIndex":"1","optionid":"new1644938251345_0_5419541opt_1"},{"qId":"new1644938251345_0_5146844","qIndex":"3","optionid":"new1644938251345_0_5146844opt_2"},{"qId":"new1644938251345_0_5112539","qIndex":"4","optionid":"new1644938251345_0_5112539opt_2"},{"qId":"new1644938251345_0_5116870","qIndex":"5","optionid":"new1644938251345_0_5116870opt_2"},{"qId":"new1644938251345_0_3504548","qIndex":"8","optionid":"new1644938251345_0_3504548opt_2"},{"qId":"new1644938251345_0_5525304","qIndex":"13","optionid":"new1644938251345_0_5525304opt_2"},{"qId":"new1644938251345_0_7951755","qIndex":"14","optionid":"new1644938251345_0_7951755opt_2"},{"qId":"new1644938251345_0_6919476","qIndex":"15","optionid":"new1644938251345_0_6919476opt_3"},{"qId":"new1644938251345_0_7639759","qIndex":"16","optionid":"new1644938251345_0_7639759opt_1"}]}
        e=session.post(url='https://salad.academy/api//score/certificate/62061619f1b643619562807e',json=data,headers=headers,proxies=proxies,timeout=5)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/6250931eb3e6eb6c0432fc6e',json=data,headers=headers,proxies=proxies,timeout=5)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/6203600f8e6ad33b402fd218',json=data,headers=headers,proxies=proxies,timeout=5)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/6250952b81330d67a55b2ebc',json=data,headers=headers,proxies=proxies,timeout=5)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/620b0f84d7fa2d134a4547f4',json=data,headers=headers,proxies=proxies,timeout=5)
        print('kk')
        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/625096de8a7d135507761eba',json=data,headers=headers,proxies=proxies,timeout=5)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/620369a15b07243961031fa6',json=data,headers=headers,proxies=proxies,timeout=5)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/625099d7e007603fad0c505a',json=data,headers=headers,proxies=proxies,timeout=5)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/623d285ab937597726670f0e',json=data,headers=headers,proxies=proxies,timeout=5)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/62509b21aeb5af21f25343ce',json=data,headers=headers,proxies=proxies,timeout=5)
        times += 1
    except:
        print('except: '+mail)
        print(con)
        retry(mail,session,cont)
        times+=1