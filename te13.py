...
tiqu = 'http://tiqu.ipidea.io:2330/getProxyIp?big_num=710&return_type=json&lb=1&sb=0&flow=1&regions=us&protocol=http'
...
a=requests.get('https://google.com',headers=headers,proxies=proxies)
for cnt in range(250,500):
    ans=str(cnt)
    mail=ans + "@cgy188.com"
    print('正在运行:'+mail)
    data={
