...
def retry(k):
    try:
        ...
        print('正在运行:' + mail)
        data = {
            "email": mail, "password": "cumark"
        }

        session = requests.Session()
        ur = 'https://salad.academy/api/signin'
        con = session.post(url=ur, headers=headers,timeout=5, proxies=proxies, json=data)
        ...
        session.post(url=class2, headers=headers,timeout=5, proxies=proxies)
        ...
        for i in iden:
            ...
            e = session.post(url='https://salad.academy/api/notifications', headers=headers,timeout=5, proxies=proxies, json=data)

        data = {
            "firstname": "cu", "lastname": "cu"

        }
        e = session.get(url='https://salad.academy/api/form/certificate/620b165f657c7401c74fe1f8', headers=headers,timeout=5,
        ...
        e = session.post(url='https://salad.academy/api//score/certificate/620b165f657c7401c74fe1f8', json=data,
        ...
        e = session.patch(url='https://salad.academy/api/assessment/submission/62509fa4054fa90202635494', json=data,
                          headers=headers,timeout=5, proxies=proxies)
        ...
        e = session.get(url='https://salad.academy/api/form/certificate/620a18fa5ba7ad2f5d595e29', headers=headers,timeout=5,
                        proxies=proxies, json=data)
        ...
        e = session.post(url='https://salad.academy/api//score/certificate/620a18fa5ba7ad2f5d595e29', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        data = {"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},
                            ...
                            {"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],
                "sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e = session.patch(url='https://salad.academy/api/assessment/submission/62509dd3e2a894018c7e38ee', json=data,
                          headers=headers,timeout=5, proxies=proxies)
        ...
        e = session.get(url='https://salad.academy/api/form/certificate/62061619f1b643619562807e', headers=headers,timeout=5,
                        proxies=proxies, json=data)
        ...
        e = session.post(url='https://salad.academy/api//score/certificate/62061619f1b643619562807e', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        data = {"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},
                            {"blockId": "survey1648400250511_283", "answer": {"value": "good"}},
                            {"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],
                "sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e = session.post(url='https://salad.academy/api/assessment/submission/6250931eb3e6eb6c0432fc6e', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        iden = ['622abc3967c500505d0292ac', '62031eadb3880755876af8b9', '622ac0fcd303bd31d255eacc',
            ...
            , '622ac2f388c4a3561f3c8160', '62031fca2a1a676b9903ca68', '622ac5e7a234c9025b622065',
                '62031ff6b6f60b612a06f8d3', '6240273ad503602fd97f37b0', '6203600f8e6ad33b402fd218','6253bfd386cfba552c1612ce']
        ...
        e = session.get(url='https://salad.academy/api/form/certificate/6203600f8e6ad33b402fd218', headers=headers,timeout=5,
                        proxies=proxies, json=data)
        data = {"maxscore": 18,
        ...
        e = session.post(url='https://salad.academy/api//score/certificate/6203600f8e6ad33b402fd218', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        data = {"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},
                            ...
                            {"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],
                "sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e = session.post(url='https://salad.academy/api/assessment/submission/6250952b81330d67a55b2ebc', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        e = session.get(url='https://salad.academy/api/form/certificate/620b0f84d7fa2d134a4547f4', headers=headers,timeout=5,
                        proxies=proxies, json=data)
        ...
        e = session.post(url='https://salad.academy/api//score/certificate/620b0f84d7fa2d134a4547f4', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        data = {"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},
                            ...
                            {"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],
                "sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e = session.post(url='https://salad.academy/api/assessment/submission/625096de8a7d135507761eba', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        e = session.get(url='https://salad.academy/api/form/certificate/620369a15b07243961031fa6', headers=headers,timeout=5,
                        proxies=proxies, json=data)
        ...
        e = session.post(url='https://salad.academy/api//score/certificate/620369a15b07243961031fa6', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        data = {"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},
                            ...
                            {"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],
                "sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e = session.post(url='https://salad.academy/api/assessment/submission/625099d7e007603fad0c505a', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        e = session.get(url='https://salad.academy/api/form/certificate/623d285ab937597726670f0e', headers=headers,timeout=5,
                        proxies=proxies, json=data)
        ...
        e = session.post(url='https://salad.academy/api//score/certificate/623d285ab937597726670f0e', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        ...
        data = {"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},
                            ...
                            {"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],
                "sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e = session.post(url='https://salad.academy/api/assessment/submission/62509b21aeb5af21f25343ce', json=data,
                         headers=headers,timeout=5, proxies=proxies)
        print('ok')
    except:
        print('except: '+k)
...
def myC(mail):
    try:
        ...
        class2='https://salad.academy/api/user/register/6204be454d1e14096f23305a'
        pag='https://salad.academy/course/axie-arena-mastery'
        con=session.get(url=pag,headers=headers,timeout=5,proxies=proxies)
        data1={
            "token":cont,
        }
        #print(con.text)
        ...
        iden=['622ac654667d5c50f458ee6d','620b159b37d5066ec556c1b8','622ac6b05ab0be2dc810b20c','620b15b88cc6e032a84414e5','620b15c13f8a6e00f10e3215','620b15c7bafd926de86f5176'
              ...
              ,'620b164ba381275d2070fb56','620b1650f073d07aea5f9541','620b165f657c7401c74fe1f8','624026f190c46068eb246f65','6253bd7c6a6f0b39e168ec7a']
        ...
        e=session.get(url='https://salad.academy/api/form/certificate
        e=session.post(url='https://salad.academy/api//score/certificate/62061619f1b643619562807e',json=data,headers=headers,timeout=5,proxies=proxies)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/6250931eb3e6eb6c0432fc6e',json=data,headers=headers,timeout=5,proxies=proxies)
        ...
        iden=['622abc3967c500505d0292ac','62031eadb3880755876af8b9','622ac0fcd303bd31d255eacc','62031cdd6ccafb1f352bf495','622ac24c030a3f174429c576','62031f731bdbe860652cbc3a'
              ,'622ac2f388c4a3561f3c8160','62031fca2a1a676b9903ca68','622ac5e7a234c9025b622065','62031ff6b6f60b612a06f8d3','6240273ad503602fd97f37b0','6203600f8e6ad33b402fd218','6253bfd386cfba552c1612ce']
        ...
        e=session.get(url='https://salad.academy/api/form/certificate/6203600f8e6ad33b402fd218',headers=headers,timeout=5,proxies=proxies,json=data)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/6203600f8e6ad33b402fd218',json=data,headers=headers,timeout=5,proxies=proxies)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/6250952b81330d67a55b2ebc',json=data,headers=headers,timeout=5,proxies=proxies)


        iden=['622ac64efb8ccd66020546c9','620b0f65835e2d1753000e98','624027df72bfd61b1f27b1de','620b0f84d7fa2d134a4547f4','6253bb9300bb4b0c39452fee']
        ...
        e=session.get(url='https://salad.academy/api/form/certificate/620b0f84d7fa2d134a4547f4',headers=headers,timeout=5,proxies=proxies,json=data)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/620b0f84d7fa2d134a4547f4',json=data,headers=headers,timeout=5,proxies=proxies)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/625096de8a7d135507761eba',json=data,headers=headers,timeout=5,proxies=proxies)
        ...
        iden=['622ac490bf558552b3773312','620368d552577826276edd8a','622ac4ff667d5c50f458ee66','620368ea37180f4e75365e25','622ac56038cf0a0d743867b7','62036931341f2a0ff7193fb5'
              ,'622ac5d8c7ce240d0937fcf9','62402876dce4230f33269e21','620369a15b07243961031fa6','62525c6b0ec4945d984361ef']
        ...
        e=session.get(url='https://salad.academy/api/form/certificate/620369a15b07243961031fa6',headers=headers,timeout=5,proxies=proxies,json=data)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/620369a15b07243961031fa6',json=data,headers=headers,timeout=5,proxies=proxies)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/625099d7e007603fad0c505a',json=data,headers=headers,timeout=5,proxies=proxies)
        ...
        iden=['623d249b39165a44637bbab8','623d251b738f7d296e058ca9','623d253e3157944c8f7bde47','623d254dd86c320310434345','623d25b8b65e261fa904c7f6','623d25bf3de23e78c75ba252'
              ,'623d275301188f5d560b6017','623d2787e90e126b4c0e60ad','624026b69ab32072b53b4af0','623d285ab937597726670f0e','6253c0a7a6378d73c40555ee']
        ...
        e=session.get(url='https://salad.academy/api/form/certificate/623d285ab937597726670f0e',headers=headers,timeout=5,proxies=proxies,json=data)
        ...
        e=session.post(url='https://salad.academy/api//score/certificate/623d285ab937597726670f0e',json=data,headers=headers,timeout=5,proxies=proxies)

        data={"answers": [{"blockId": "survey1648400250511_276", "answer": {"value": 5}},{"blockId": "survey1648400250511_283", "answer": {"value": "good"}},{"blockId": "survey1648400250511_285", "answer": {"value": "well"}}],"sendAnonymousSubmissionsToEmailLeadsOverride": "false", "status": "submitted"}
        e=session.post(url='https://salad.academy/api/assessment/submission/62509b21aeb5af21f25343ce',json=data,headers=headers,timeout=5,proxies=proxies)
    except:
        print('except: '+mail)
        retry(mail)
...
if __name__ == '__main__':
    ...
    mail=str(times)+post
    li=[]
    for cnt in range(int(start),int(end)):
        thi = str(cnt)
        ans = str(thi)
        mail = ans + post
        li.append(mail)
